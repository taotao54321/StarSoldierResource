...
* `homing_timer` レジスタが非0ならば自機を[追尾する方向](@/direction/index.md#aim)へ移動して戻る。ただし敵が[再行動フラグ](@/enemy-group/index.md#param-extra-act)を持つとき、特定条件下でさらにバイトコードを実行する。
...
オペコード下位4bitの[方向](@/direction/index.md)に方向指定弾を撃つことを試みる。  
