...
|`$80`|`u8`|タイトル画面からデモに移行するまでのカウント (0..=10) (64F ごとにデクリメント)|
...
|`$8C`|`u8`||
|`$8D`|`u8`||
|`$8E-$91`|`u8[4]`|効果音 各チャンネルの再生残り時間|
|`$92`|`u8`||
|`$93`|`u8`||
|`$94`|`u8`||
|[`$95`](#addr-95)|`u8`|BGM IDおよびBGM初期化済フラグ|
|`$96`|`u8`||
|`$97-$9C`|`ptr[3]`|BGM 各トラックデータへのポインタ (矩形波1, 矩形波2, 三角波)|
|`$9D-$9F`|`u8[3]`|BGM 各トラックで再生する音の初期長さ|
|`$A0-$A2`|`u8[3]`|BGM 各トラックで再生する音の残り長さ|
...
## `$95` - BGM IDおよびBGM初期化済フラグ {#addr-95}

* bit0-6: BGM ID
* bit7: BGM初期化済フラグ (0:false, 1:true)
